...
(meditations
  ...
  "Also multiple paths with condp, condp can be used if your predicate remains the same for each condition and you wish to switch on the result"
  (let [account {:amount 2500}]
   (= "first tier dividend" (condp < (:amount account)
